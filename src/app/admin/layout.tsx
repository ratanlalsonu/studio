...
import { LayoutDashboard, ShoppingCart, Users, Package, LogOut, PlusSquare, Upload, Handshake } from 'lucide-react';
...
const sidebarNavItems = [
  ...
  { href: '/admin/sellers', label: 'Seller Apps', icon: Handshake },
